        ...
        <>
            <header className="navbar">
                <div className="container navbar__inner">
                    {/* Logo */}
                    <Link to="/" className="navbar__logo" aria-label="IFPMEB – Accueil">
                        <div className="navbar__logo-mark">
                            {/* [LOGO_PLACEHOLDER] Replace <div> with <img src="logo-ifpmeb.svg" /> */}
                            <span className="navbar__logo-icon">🎓</span>
                        </div>
                        <span className="navbar__logo-text">IFPMEB</span>
                    </Link>
